			...
			<table class="outerBounds">
				<tr>
					<td>
							<table class="box">
								<tr>
									<td class="box-main_logo" align="left"></td>
									<td class="box-main_title" align="right">
									<table>
										<tr><td class="head_title" ><?php echo $config_proftp_admin_name; ?></td></tr>
										<tr><td class="head-user-menu" ><a href="http://logout@10.2.17.23/proftpd_admin/"> Logout </a></td></tr>
									</table>
									</td>
								</tr>
							</table>
